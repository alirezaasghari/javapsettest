package at.refugeescode.javapsettest.pset1.controller;

import at.refugeescode.javapsettest.pset1.model.Actor;
import at.refugeescode.javapsettest.pset1.model.Gender;
...
public class MovieDatabaseSummarizer {
    ...
    public Summary summarize() {
        ...
        List<Movie> movies = movieParser.asList("src/main/java/at/refugeescode/javapsettest/pset1/data/movies.csv");
        List<Actor> actors = actorParser.asList("src/main/java/at/refugeescode/javapsettest/pset1/data/actors.csv");
